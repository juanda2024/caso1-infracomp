...
/**
 * Clase que represnta un cliente, este tiene una cantidad de mensajes que envia
 * al buffer para ser procesados, cada cliente cuenta con identificador unico.
 * 
 */
...
public class Cliente extends Thread {
	...
	// ----------------------------------------------------------------------------------------------------------
	/**
	 * Crea un objeto cliente con una cantidad de mensajes, un identificador y una
	...
	/**
	 * Metodo que crea mensajes, duerme para que otros clientes puedan crear sus
	 * mensajes y los envia al buffer <b>pre: </b> debe exitir un buffer <b>post:
	 * </b> se crea mensajes y los coloca en el buffer
	 */
	public void run() {
		for (int i = 0; i < cantidad_mensajes; i++) {
			Mensaje nuevo_mensaje = new Mensaje(i, this);
			yield();
	...
	/**
	 * Metodo que aumenta la cantidad de mensajes procesados y se encarga de definir
	 * si el cliente finalizo el proceso <b>pre: </b> se debio recoger un mensaje
